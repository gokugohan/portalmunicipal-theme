...
<footer id="footer">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-info">
                        <p><?= filter_text_wpglobus(get_theme_mod('municipality_address_entity_name', 'Ministério da Administração Estatal')) ?></p>
    ...
    <div class="container">
        <div class="copyright">
            © <?= date('Y') ?> <strong><span>Ministério da Administração Estatal de Timor-Leste</span></strong>. All
            Rights Reserved
        </div>
    </div>
</footer>
