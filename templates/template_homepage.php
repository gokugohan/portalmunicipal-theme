                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="tt--map" style="border: #ccc; clear: both">
                                <div class="row">
                                    <div class="col-xl-11 col-lg-10 col-md-12 order-lg-1">
                                        <div id="map-container">Loading...</div>
                                    </div>
                                    <div class="col-xl-1 col-lg-2 col-md-12 order-lg-0 map-icon pt-5">
                                        <ul class="map-description add_li " style="list-style: none;">Loading...</ul>
                                    </div>
...
//    'taxonomy' => 'library_category',
    ...
    <section class="section section-lg pt-4" id="biblioteka">
        <div class="container-fluid pt-5">
            <h2 class="text-center text-uppercase font-weight-regular" style="color: #960807;"><?= lang('library') ?></h2>
